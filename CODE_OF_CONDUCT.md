# Contributor Covenant Code of Conduct — Configra
# SPDX-License-Identifier: MIT OR Apache-2.0

## Our Pledge

We as members, contributors, and leaders pledge to make participation in the
**Configra** project and our community a harassment-free experience for
everyone, regardless of age, body size, disability (visible or invisible),
...
issue tracker, pull requests, discussions, chat channels, and any other
forum or venue where the project is represented — and also applies when an
...
**`koosha@phenotype.org`** (or via GitHub private message to `@kooshapari`).
